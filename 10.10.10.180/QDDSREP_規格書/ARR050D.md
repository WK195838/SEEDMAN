# 應收帳款系統—客戶電子郵件發票明細查詢顯示檔規格書（ARR050D）
...
- **建立日期**：81/04/24
- **修改記錄**：
  - M001 102/12/20 DAISY 判斷電子郵件發票是否已寄送
- **備註**：客戶電子郵件發票明細查詢畫面
...
本規格書已依據 ARR050D.txt 製作，完整記錄 ARR050D 顯示檔結構與用途。如需調整或有其他需求，歡迎隨時告知！ 