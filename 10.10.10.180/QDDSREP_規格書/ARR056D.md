# 應收帳款系統—同業暫收款明細查詢顯示檔規格書（ARR056D）
...
| 位置(行,列) | 欄位說明 | 顯示格式 | 特性 |
|------------|---------|---------|------|
| 6,36 | 公司別起 | DSG01S (2A) | 必填，反白 |
| 6,47 | 公司別迄 | DSG01E (2A) | 必填，反白 |
| 8,36 | 暫收日期起 | DSG06S (6Y) | 必填，反白，EDTWRD('  /  /  ') |
| 8,47 | 暫收日期迄 | DSG06E (6Y) | 必填，反白，EDTWRD('  /  /  ') |
...
本規格書已依據 ARR056D.txt 製作，完整記錄 ARR056D 顯示檔結構與用途。如需調整或有其他需求，歡迎隨時告知！ 