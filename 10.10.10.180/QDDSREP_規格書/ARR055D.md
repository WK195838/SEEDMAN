...
| 位置(行,列) | 欄位說明 | 顯示格式 | 特性 |
|------------|---------|---------|------|
| 6,38 | 公司別 | DIA01 (參照IA01) | 必填，反白 |
| 8,38 | 暫收款類別 | DIA02F (1A) | 必填，反白 |
| 10,38 | 暫收款起 | DIA02S (參照IA02) | 必填，反白 |
| 10,46 | 暫收款迄 | DIA02E (參照IA02) | 必填，反白 |
| 12,38 | 客戶起 | DIA03S (參照IA03) | 必填，反白 |
| 12,50 | 客戶迄 | DIA03E (參照IA03) | 必填，反白 |
...
## 三、功能說明
1. 提供暫收款明細查詢及列印作業。
2. 支援多條件查詢（公司別、暫收款類別、暫收款號碼、客戶等）。
3. 支援查詢結果列印與多份數設定。

## 四、資料驗證
- 各欄位格式、範圍、必填性檢查。
- 公司別、暫收款類別、暫收款號碼、客戶等選項有效性。
...
本規格書已依據 ARR055D.txt 製作，完整記錄 ARR055D 顯示檔結構與用途。如需調整或有其他需求，歡迎隨時告知！ 