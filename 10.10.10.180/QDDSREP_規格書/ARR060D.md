...
| 位置(行,列) | 欄位說明 | 顯示格式 | 特性 |
|------------|---------|---------|------|
| 6,26 | 公司別 | DSI01 (參照SI01) | 必填，反白 |
| 8,26 | 到期年月 | DSI21S (4Y) | 必填，反白，EDTWRD('  /  ')，(MM/YY) |
...
| 24,2 | 錯誤訊息11 | ERR11 (50A) | 輸出(O)，MSGID(URE 0073 REMF)，高亮度 |
...
本規格書已依據 ARR060D.txt 製作，完整記錄 ARR060D 顯示檔結構與用途。如需調整或有其他需求，歡迎隨時告知！ 